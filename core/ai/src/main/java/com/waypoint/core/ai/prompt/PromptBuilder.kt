...
class PromptBuilder @Inject constructor() {
    ...
    private fun buildUserBlock(prompt: String, ctx: TripContext): String =
        buildString {
            append("USER_REQUEST:\n")
            append(prompt.trim())
            append("\n\n")
    ...
    private fun List<String>.joinIfEmpty(emptyText: String): String =
        if (isEmpty()) emptyText else joinToString(", ")
}